...
// only one thread can lock/unlock a specific lock. making the lock variables
// private fixed the deadlock when both threads tried to access the same lock variable
#pragma omp parallel shared(a, b, nthreads) private(tid, locka, lockb)
  {
